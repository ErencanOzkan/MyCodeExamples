package com.code.examples.concurrent;
    ...
    Thread this_thread = Thread.currentThread();
        while (true) {
            ...
            if (LockExample.message == 0) {
                ...
                LockExample.report("The Listener just received " + Integer.toString(LockExample.message) + " from the Speaker.");
    ...
    Thread this_thread = Thread.currentThread();
        while (true) {
            while (0 != LockExample.message) {
                try {
                    LockExample.report("The Speaker waits for the Listener to catch up.");
            ...
            LockExample.report("The Speaker takes a nap--a model for real work it might otherwise do.");
            try {
